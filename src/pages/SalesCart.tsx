...
import { generateCustomInvoice, getInvoiceTemplateConfig } from '@/utils/templateUtils';
...
export const SalesCart = ({ username, onBack, onLogout }: SalesCartProps) => {
  ...
  const generateAndDisplayInvoice = () => {
    ...
    // Create a transaction object for the invoice
    const transaction = {
      ...
      change: parseFloat(amountReceived) || 0,
      customer: selectedCustomer // Include customer information
    };
    
    // Print the invoice using the PrintUtils
